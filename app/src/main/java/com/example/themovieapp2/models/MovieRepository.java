...
import com.example.themovieapp2.serviceapi.MovieApiService;
import com.example.themovieapp2.serviceapi.RetrofitApp;
...
public class MovieRepository {
    ...
    public MutableLiveData<List<Movie>> getMutableLiveData() {
        MovieApiService movieApiService = RetrofitApp.getService();
